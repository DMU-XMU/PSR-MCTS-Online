...
public class RockSample5_5 extends BSimulator {

    public RockSample5_5(long seed, int maxRunLength) {
        super(seed, maxRunLength);
    }

    public RockSample5_5(long seed) {
        super(seed);
    }

    @Override
    public String getName() {
        return "RockSample5_5";
    }
    ...
    protected void initRun() {
        ...
        Coord[] rocks={new Coord(2,4),new Coord(0,4),new Coord(3,3),new Coord(2,2),
                new Coord(4,1)};
        rockPos=new Vector<>();
    ...
    boolean[] isCollectedCopy=new boolean[5];
